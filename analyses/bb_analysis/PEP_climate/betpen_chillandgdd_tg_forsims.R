...
#write.csv(full.site.nonas, file="output/betpen_allchillsandgdds_45sites_forsims.csv", row.names = FALSE)

##################################################################################################
############################### MEAN TEMP instead of GDD #########################################
##################################################################################################
#full.site <- read.csv("output/betpen_allchillsandgdds_45sites_forsims.csv", header = TRUE)
...
write.csv(fullsites45, file="output/betpen_allchillsandgdds_45sites_mat_forsims.csv", row.names = FALSE)

##################################################################################################
################################# Now for some plots! ############################################
##################################################################################################
#fullsites45 <- read.csv("output/betpen_allchillsandgdds_45sites_mat_forsims.csv", header=TRUE)
