...
bb.resp$force.cent <- bb.resp$force/mean(bb.resp$force,na.rm=TRUE)
bb.resp$photo.cent <- bb.resp$photo/mean(bb.resp$photo,na.rm=TRUE)
bb.resp$chill.cent <- bb.resp$chill/mean(bb.resp$chill,na.rm=TRUE)
...
####remove weinburgers
#weinberg<-c("falusi03","falusi97","heide93","jones12","partanen05",
 #           "ramos99","ashby62","basler14","biasi12","boyer","calme94","charrier11","cook00b","ganset02","gianfagna85","guerriero90","gunderson12")
