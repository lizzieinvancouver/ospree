...
save(m2l.ni, file="bb_analysis/bbmodels_saturna/M1_daysBBnointer_2level_center.Rda")
...
save(m2l.winsp, file="bb_analysis/bbmodels_saturna/M1_daysBBwinternosp_2level.Rda")
...
save(m2l.wi, file="bb_analysis/bbmodels_saturna/M1_daysBBwinter_2level.Rda")

mint.sum <- summary(m2l.wi)$summary
mint.sum[grep("mu_", rownames(mint.sum)),]
mint.sum[grep("sigma_", rownames(mint.sum)),]
...
###No photoperiod
m2l.wi.no.photo = stan('bb_analysis/bbmodels_saturna/M1_daysBBwinter_2levelnophoto.stan', data = datalist.bb,
              iter = 2500, warmup=1500)
...
m2l.3winsp = stan('bb_analysis/bbmodels_saturna/M1_daysBBwALLinternosp_2level.stan', data = datalist.bb,
              iter = 2500, warmup=1500)

save(m2l.3winsp, file="bb_analysis/bbmodels_saturna/M1_daysBBwALLinternosp_2level.Rda")
