...
#chill ports, z
load("../../analyses/lat_analysis/stan/output/m2l.inter.lat.z.Rda") # m2l.inter
fit.z <- summary(m2l.inter)$summary
ztab<-as.data.frame(round(cbind(fit.z[1:13,1],fit.z[1:13,4],fit.z[1:13,8]),digits=2))
...
write.csv(zmodtable,"../../analyses/output/supptables/zmodetable_latcpz.csv", row.names = FALSE)
