...
##### Species were selected if they were in one or more studies and if studies manipulated more than one cue
### Complexes were selected if (1) they were not already species (2) the genus was used in one or more studies and (3) those studies used more than one cue
...
sppcomplexfx.less.strict <- function(d){
