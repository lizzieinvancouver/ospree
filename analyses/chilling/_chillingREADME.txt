...
chill_all.R the file that puts it all together, using the below files that our sourced.
...
1. cleaning_chilltemp.R: cleans the non-numeric data from the chilltemp column in ospree_clean.csv, and creates a new version of ospree with a cleaned chill temp column called ospree_clean_XXX.csv
