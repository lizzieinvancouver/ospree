...
#d[which(d$chilldays=="40,55,60 (mean across these presented)"),]$chillbyhand<-1#skuterud94- need to look at this paper to figure out the childays stuff and then add it to totalchillcal.R file
#d[which(d$chilldays=="mean of 39, 55, 67, 98, 111"),]$chillbyhand<-1#skuterud94- need to look at this paper to figure out the childays stuff and then add it to totalchillcal.R file
