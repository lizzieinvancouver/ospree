...
d$ID_fieldsample.date<-paste(d$datasetID,d$chill.lat,d$chill.long,d$fieldsample.date, sep="_")
...
eur <- d %>% # start with the data frame
  ...
  dplyr::select(datasetID, chill.lat, chill.long, year,fieldsample.date, ID_fieldsample.date)
