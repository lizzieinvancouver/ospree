...
d$growing.long[which(d$continent=="europe" & as.numeric(d$growing.long)==-119.7670)] <-
    d$provenance.long[which(d$continent=="europe" & as.numeric(d$growing.long)==-119.7670)]
d$growing.lat[which(d$continent=="europe" & as.numeric(d$growing.long)==-119.7670)] <-
    d$provenance.lat[which(d$continent=="europe" & as.numeric(d$growing.long)==-119.7670)]
d$growing.long[which(d$continent=="europe" & as.numeric(d$growing.long)==-82.3250)] <-
    d$provenance.long[which(d$continent=="europe" & as.numeric(d$growing.long)==-82.3250)]
d$growing.lat[which(d$continent=="europe" & as.numeric(d$growing.long)==-82.3250)] <-
    d$provenance.lat[which(d$continent=="europe" & as.numeric(d$growing.long)==-82.3250)]
d$growing.long[which(d$continent=="europe" & as.numeric(d$growing.long)==-81.9372)] <-
    d$provenance.long[which(d$continent=="europe" & as.numeric(d$growing.long)==-81.9372)]
...
d$continent[which(d$continent=="europe" & as.numeric(d$growing.long)==-89.4120)]<-"north america" # this seems to be the correct longitude, given that the author is a professor at university of wisconsin. changet the continent to North America?
