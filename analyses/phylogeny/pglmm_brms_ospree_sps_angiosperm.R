...
bb.stan <- subset(bb.stan, !spps %in% gymnospp)
...
#load model result
save(model_NOphylo.FULL.sps,file = "output/full_nophylomodsps_angio.RData")
save(model_NOphylo.FULL.b.sps,file = "output/full_nophylomodsps.b_angio.RData")
save(model_phylo.FULL.c.sps,file = "output/full_phylomod.csps_angio.RData")
...
#load model result
save(model_phylo.int.only.sps,file = "output/model_phylo.int.only.RData")
