...
// with just species grouped on the intercept but NOT partially pooled, and phylogeny on the slopes
...
parameters {
 ...
 // real mu_a; // mean intercept for species
 // real sigma_a; // sigma intercept for species
