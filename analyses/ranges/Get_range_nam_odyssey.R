...
Climate.in.range<-extractchillforce(ospreefolder[8],tmin,tmax,period)
...
write.csv(Climate.in.range, file = paste("/n/wolkovich_lab/Lab/Cat/Climate.in.range",ospreefolder[8],
