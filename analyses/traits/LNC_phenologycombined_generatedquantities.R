...
saveRDS(object = mdl.traitphen, file = "LNC_stanfit_generatedquantities.RDS")

mdl.traitphen.ext <- extract(mdl.traitphen)

pdf(file = "figures/Posterior_prediction_check_LNC_1.pdf", width = 10, height = 6)
par(mar = c(5, 6, 2, 2))
...
pdf(file = "figures/Posterior_prediction_check_LNC_2.pdf", width = 15, height = 6)
