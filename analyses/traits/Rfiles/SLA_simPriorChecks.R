...
mu.grand <- 30 # the grand mean of the LNC model
...
# 
#       
      png("figures/simPosteriorHist_SLA.png")
       par(mfrow=c(3,4))
...
if(priorCheck == TRUE){
	...
	png("figures/priorChecks/density_Trait_Prior_SLA.png")
	plot(density(priorCheckTrait$yTraiti), xlab = "Predicted day of budburst", main = "SLA Prior Check")
	dev.off()
	
	png("figures/priorChecks/GrandSp_PlotPrior_SLA.png")
	plot(priorCheckTrait$yTraiti ~ priorCheckTrait$muGrandSp, xlab = "muGrandSp", ylab = "Trait", main = "SLA Prior Check")
	dev.off()
	
	png("figures/priorChecks/MuSp_PlotPrior_SLA.png")
	plot(priorCheckTrait$yTraiti ~ priorCheckTrait$muSp, xlab = "MuSp", ylab = "Trait", main = "SLA Prior Check")
	dev.off()
	
	png("figures/priorChecks/MuStudy_PlotPrior_SLA.png")
	plot(priorCheckTrait$yTraiti ~ priorCheckTrait$muStudy, xlab = "MuStudy", ylab = "Trait", main = "SLA Prior Check")
	dev.off()
#####################################################################################
	...
	png("figures/priorChecks/densityYPrior_SLA.png")
	plot(density(priorCheckPheno$yPhenoi), xlab = "Predicted day of budburst", main = "SLA Prior Check")
	dev.off()

	png("figures/priorChecks/photoPlotPrior_SLA.png")
	plot(priorCheckPheno$yPhenoi ~ priorCheckPheno$photoi, xlab = "Photoperiod", ylab = "Phenological Date", main = "SLA Prior Check")
	dev.off()

	png("figures/priorChecks/forcingPlotPrior_SLA.png")
	plot(priorCheckPheno$yPhenoi ~ priorCheckPheno$forcei, xlab = "Forcing", ylab = "Phenological Date", main = "SLA Prior Check")
	dev.off()

	png("figures/priorChecks/chillingPlotPrior_SLA.png")
	plot(priorCheckPheno$yPhenoi ~ priorCheckPheno$chilli, xlab = "Chillina", ylab = "Phenological Date", main = "SLA Prior Check")
	dev.off()
