...
testfixed <- lm(yTraiti ~ study + species, data = trt.dat)
summary(testfixed)
...
# 81 divergent transitions, need to increase treedepth: but model output doesn't look bad
# sigmaTrait_y   0.4961571 
# mu_grand       19.3444106 
# sigma_sp       9.905089
#sigma_study     4.695025
