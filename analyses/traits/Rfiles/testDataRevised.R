...
param <- list(
  ...
  Nstudy = 2, # number of studies with traits
...
mdl.traitphen <- stan("stan/phenology_combined.stan",
                      ...
                      seed = 202109)
mdl.traitphen <-mdl.traitphen2
summary(mdl.traitphen, pars = c("mu_grand"))$summary 
## True value
param[["trait_mu_grand"]]

summary(mdl.traitphen, pars = c("betaTraitxChill"))$summary
## True value
param[["phenology_betaTraitChill"]]

summary(mdl.traitphen, pars = c("betaTraitxForce"))$summary
## True value
param[["phenology_betaTraitForce"]]

summary(mdl.traitphen, pars = c("betaTraitxPhoto"))$summary
## True value
param[["phenology_betaTraitPhoto"]]


summary(mdl.traitphen, pars = c("muForceSp"))$summary
param[["phenology_muForce"]]

summary(mdl.traitphen, pars = c("muChillSp"))$summary
param[["phenology_muChill"]]

summary(mdl.traitphen, pars = c("muPhotoSp"))$summary
param[["phenology_muPhoto"]]

summary(mdl.traitphen, pars = c("muPhenoSp"))$summary
param[["phenology_muAlpha"]]

summary(mdl.traitphen, pars = c("sigma_sp"))$summary
## True value
param[["trait_sigma_sp"]]

summary(mdl.traitphen, pars = c("sigma_study"))$summary
## True value
param[["trait_sigma_study"]]

summary(mdl.traitphen, pars = c("sigma_traity"))$summary
## True value
param[["trait_sigma_traity"]]

summary(mdl.traitphen, pars = c("sigmaForceSp"))$summary
param[["phenology_sigmaForce"]]

summary(mdl.traitphen, pars = c("sigmaChillSp"))$summary
param[["phenology_sigmaChill"]]

summary(mdl.traitphen, pars = c("sigmaPhotoSp"))$summary
param[["phenology_sigmaPhoto"]]

summary(mdl.traitphen, pars = c("sigmaPhenoSp"))$summary
param[["phenology_sigmaPheno"]]
...
pdf("simPosteriorHist_fullModel.pdf")
...
#Compare results to simulated values
pdf("figures/simPosteriorHist_fullModel_widePriorsMay18.pdf")
