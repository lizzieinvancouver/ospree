...
trait_data <- list(yTraiti = trt.dat$yTraiti, 
                   ...
                   n_study = Nstudy,
                   prior_mu_grand = 1.3,
                   prior_sigma_grand = 0.3,
                   prior_mu_sp = 0,
                   prior_sigma_sp_mu = 2,
                   prior_sigma_sp_sigma = 0.75,
                   prior_mu_study = 0,
                   prior_sigma_study_mu = 3,
                   prior_sigma_study_sigma = 1.5,
...
save(mdl.traitonly, file = "output_compare_oldvsGDD.Rda")
...
load(file = "output/output_compare_oldvsGDD.Rda")
...
summary(mdl.traitonly, pars= c("a_variety"))
