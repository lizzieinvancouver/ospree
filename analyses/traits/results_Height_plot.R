...
colnames(posterior_ht$alphaPhenoSp) <- specieslist
colnames(posterior_ht$alphaForceSp) <- specieslist
colnames(posterior_ht$alphaChillSp) <- specieslist
colnames(posterior_ht$alphaPhotoSp) <- specieslist
