...
pdf(file = "figures/results_height_forcing.pdf", width = 7, height = 6)
## Plotting
### Forcing
par(mar = c(5, 5, 2, 2))
...
pdf(file = "figures/results_height_chilling.pdf", width = 7, height = 6)
## Plotting
### Chilling
par(mar = c(5, 5, 2, 2))
...
pdf(file = "figures/results_height_photoperiod.pdf", width = 7, height = 6)
## Plotting
### Photoperiod
par(mar = c(5, 5, 2, 2))
