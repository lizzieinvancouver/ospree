...
pdf(file = "figures/results_lnc_forcing.pdf", width = 7, height = 6)
## Plotting
### Forcing
par(mar = c(5, 5, 2, 2))
...
pdf(file = "figures/results_lnc_chilling.pdf", width = 7, height = 6)
## Plotting
### Chilling
par(mar = c(5, 5, 2, 2))
...
pdf(file = "figures/results_lnc_photoperiod.pdf", width = 7, height = 6)
## Plotting
### Photoperiod
par(mar = c(5, 5, 2, 2))
xrange <- seq(-2.5, 2.5, by = 0.25)
