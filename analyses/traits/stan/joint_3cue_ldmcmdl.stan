...
model{ 
    //MODEL 1 ---------------------------------------------
    //assign priors
    sigmaTrait_y ~ normal(0.5,0.1); // ranges from 0-0.7
    ...
    sigmaPhenoSp ~ normal(10, 0.5); // sigma.pheno.sp =2  normal(11, 0.5)
