...
parameters{
    ...
    vector[n_spec] muSp; //The trait effect of each species without study 

    real <lower = 0> sigma_study; // variation of intercept amoung studies
    vector[n_study] muStudy; // mean of the alpha value for studies
...
transformed parameters{
    ...
    vector[N] ymu; // the trait value, height, ssd, etc.
   // vector[n_spec] mu_grand;
    //MODEL 2------------------------------------------------
