...
utah.table <- xtable(utahmod, caption="\\textbf{Utah chill units}, which were developed for peach species in North America \\citep{richardson1974} and has now been widely adopted around the world. The model assigns chilling units or portions of units for each hour at a given temperature (in \\degree C), as shown.",
