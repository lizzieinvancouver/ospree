...
We classified Weinberger studies as those with two or more field sample dates, each two or more weeks apart. The Weinberger model is:\\
\begin{align*}
y_i &= N(\alpha_{sp[i]} + \beta_{forcing} + \beta_{photoperiod} + \beta_{chilling}+ \beta_{weinberger} + \beta_{forcing:weinberger} + \beta_{photoperiod:weinberger }+ \beta_{chilling:weinberger} \epsilon_i}, \epsilon_i \sim N(0,\sigma^2_y)
\end{align*}
