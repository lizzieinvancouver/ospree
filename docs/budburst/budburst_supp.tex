...
\begin{tabular}{|p{0.10\textwidth}|p{0.04\textwidth}p{0.04\textwidth}p{0.04\textwidth}p{0.04\textwidth}p{0.04\textwidth}|}
 ...
 & mean & 25\% & 75\% & 2.5\% & 97.5\% \\ 
  \hline
$\mu_{\alpha}$ & 28.96 & 28.63 & 30.98 & 26.3 & 33.29 \\ 
  $\mu_{forcing}$ & -4.68 & -5.16 & -3.56 & -6.68 & -2 \\ 
  $\mu_{photoperiod}$ & -2.9 & -3.76 & -2.08 & -5.49 & -0.42 \\ 
  $\mu_{chilling}$ & -9.46 & -9.33 & -7.3 & -11.32 & -5.22 \\ 
  $\sigma_{\alpha}$ & 9.03 & 8.46 & 10.25 & 7.14 & 12.26 \\ 
  $\sigma_{forcing}$ & 4.35 & 5.05 & 6.32 & 4.08 & 7.84 \\ 
  $\sigma_{photoperiod}$ & 6.87 & 4.36 & 5.84 & 3.3 & 7.66 \\ 
  $\sigma_{chilling}$ & 8.32 & 6.37 & 7.92 & 5.2 & 9.89 \\ 
  $\sigma_{y}$ & 16.34 & 15.4 & 15.77 & 15.04 & 16.16 \\ 
   \hline
$N_{sp}$ & 30 &  &  &  &  \\ 
   \hline
\end{tabular}
