...
% latex table generated in R 3.6.0 by xtable 1.8-4 package
% Fri Jul 12 16:56:03 2019
\begin{table}[ht]
\centering
\caption{\textbf{Locations and pre-warming winter and spring conditions} for sites included in Fig. 3, \ref{fig:betpenfagsyl}, \ref{fig:chillfore} out of the 42 experiments (across 30 papers) included in the main budburst model} 
\label{tab:clim}
\begingroup\footnotesize
