...
\affil[a]{Corresponding author; Current affiliation email: ailene.ettinger@tnc.org; phone: 781-296-4821; mailing address: 74 Wall Street, Seattle, Washington USA}
...
\centering
\noindent 
\includegraphics[width=0.75\textwidth]{figures/concept/Fig_bbconcept_dormant_V7.png}
