...
nsp_mod<-71#got this from doing: unique(paste(bb.stan$genus,bb.stan$species) with flags for main bb mod located in snippet_for_ns.R
nst_mod<-38#got this from doing: unique(paste(bb.stan$genus,bb.stan$species) with flags for main bb mod
nexp_mod<-57#got this from doing: unique(paste(bb.stan$genus,bb.stan$species) with flags for main bb mod
@
