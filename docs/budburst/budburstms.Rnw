...
\author[3,4]{I. Morales-Castilla}

\author[3]{D. Buonaiuto}

\author[3,5]{D. F. B. Flynn}

\author[6]{J. Samaha}

\author[1,3,6]{E. M. Wolkovich}
...
\caption{\textbf{Estimates of budburst across a range of forcing temperatures and estimated chilling} (converted to a mean temperature, see \emph{Estimating chilling} in the Supplemental Methods) based on overall estimates of chilling and forcing effects (see Fig 1). Maximum advances in budburst occur at intermediate chilling temperatures (e.g., here at \Sexpr{chillminbb} chill units or a mean winter temperatures of \Sexpr{chillTminbb} \degree C) and higher forcing (here at \Sexpr{forceminbb} \degree C).  Note that days to budburst is relative to experimental methods and thus not comparable to day of year in the field, shading represents days to budburst.} % Adjust to maybe emphasize that it is a mix of the cues that determines when the earliest budburst happens *and* that these figures suggest at higher degrees of warming, when chilling declines, advances will slow or reverse.
\label{fig:apc}
\end{figure}
\newpage
