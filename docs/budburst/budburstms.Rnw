...
library(dplyr)
library(rstan)
load("..//..//analyses/bb_analysis/stan/output/m2lni_spcompexprampfputah_nonz.Rda") 
...
load("..//..//analyses/bb_analysis/stan/output/m2lni_spcompexprampfputah_z.Rda") 
