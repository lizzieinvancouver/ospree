...
are weakening in recent decades \cite{Rutishauser:2008,yu2010}, especially in Europe, where researchers suggest that responses to environmental cues beyond forcing underlie declining temperature sensitivities \cite{fu2015}.
%CJC - what do you mean by the end here? "environmental cues (so chilling and photoperiod or are you suggesting other cues?) beyond forcing underlie declining temperature sensitivities". Also should we say "warming" instead of "forcing" since we haven't introduced the concept of forcing yet?
