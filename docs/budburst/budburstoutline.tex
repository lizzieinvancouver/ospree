...
\item redo chilling estimates and spring temperature using same time periods as Cat for her PEP analysis; then summarize and compare my estimates to Cat's estimates of chilling, forcing, budburst doy and its change with warming. also use the same time periods that Cat used (1950-60= pre-warming)
\end{itemize}
...
\item Table of ospree sites and their chill, force, photo yreatments
\item List of all species included and the studies in which they were included
