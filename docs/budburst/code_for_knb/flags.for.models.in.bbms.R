if(length(which(c(use.flags.for.mainmodel,use.flags.for.spcomp.cp,use.flags.for.allspp.utah, 
                  use.flags.for.spcomp.utah.nonz,use.flags.for.spcomp.cp.nonz,use.flags.for.allspp.utah.nonz) =="TRUE"))>1) 
  print("ALERT! You have set too many master flags to true, you must pick only one!")

if(length(which(c(use.flags.for.mainmodel,use.flags.for.spcomp.cp,use.flags.for.allspp.utah, 
                  use.flags.for.spcomp.utah.nonz,use.flags.for.spcomp.cp.nonz,use.flags.for.allspp.utah.nonz) =="TRUE"))==0) 
