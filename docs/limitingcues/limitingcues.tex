...
\vspace{2ex}
{\Large How interactive cues will shape climate change responses \\
\vspace{2ex}
Limiting cues: How spring warming, winter chilling and daylength will shape climate change responses\\
\vspace{2ex}
...
\item After you carefully select the cues to study, make your reasoning clear \todo[inline]{Do we need this? AKE says no, IMC agrees.} 
\end{enumerate}
