...
\item Outline some studies showing how predictable they are \citep{Schwartz:1997nn,Menzel2003a,delpierre2009,Ellwood2012,jochner2013}
% \cite{cesaraccio2004,delpierre2009,hereford2017,jochner2013,kelly2003,legave2013,liepe2016,morin2007,piao2015}
...
\begin{enumerate}
\item Some examples: \citet{yu2010,fu2015}, also \citet{camille2015} says things are more complicated (if needed) % AKE: This isn't a "failed prediction paper," but a review stating that things are more complex than previously thought and that "considerable uncertainty remains."
