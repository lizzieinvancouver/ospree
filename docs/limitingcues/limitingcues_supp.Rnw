...
\noindent{\Large {\bf Integrating experiments to predict the interactive effects of temperature and photoperiod on spring phenological responses to warming}}\\ 
\bigskip
