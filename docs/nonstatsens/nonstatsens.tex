...
\title{The illusion of declining temperature sensitivity OR A simple explanation for declining temperature sensitivity with warming} % Sensitivities are not declining with warming OR As climate change accelerates biology, chasing statistical artifacts ensues
