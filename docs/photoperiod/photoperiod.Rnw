...
% Cat - maybe: "With future climate change, it is unclear how these complications will affect the photoperiod experienced by organisms and if these shifts in photoperiod will have important implications for biological responses." 
...
% IMC- I was wondering if we should explain a bit further the conceptural diagram figure in this section?
...
\item How much does model accuracy (process-based or statistical) improve when we include photoperiod responses and changes in photoperiod?  
