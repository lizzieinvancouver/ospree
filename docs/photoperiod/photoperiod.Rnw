...
\section*{Box 2. Dominant models of how photoperiod affects spring phenology}
...
\section* {To do:}
\begin{enumerate}
\item incorporate comments from Lizzie, Cat, Dan, Nacho
