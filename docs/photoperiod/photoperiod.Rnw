...
\section* {To do:}
\begin{enumerate}
\item Edit map showing studies with saptial and temporal equivalents: replace blue squares with asterix and make bigger.make lines transparent. 
...
\begin {enumerate}
\item Bradshaw & Holzapfel (2001) showed that the pitcher plant mosquito,
...
source("../../analyses/photoperiod/photoshifts.R")
...
\begin{figure}[p]
\centering
\includegraphics{/Users/aileneettinger/git/ospree/analyses/greenup/2009_photoperiod_map.pdf} 
