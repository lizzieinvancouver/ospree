...
\begin{enumerate}
\item Photoperiod is a critical cue used by organisms to synchronize their activities with seasonal climatic changes (add other citations- there are many possibilities! if you have favorites, please add along with 1-2 words of what the activity is)\citep[e.g.,][]{hsu2011,singh2017,basler2012,flynnrev,singh2017}.
...
\item Update Figure 1
\item Cat's figures: figure out what 5 points that are really 5 are/why they are there.
...
\begin{figure}[p]
\centering
\includegraphics{/Users/aileneettinger/git/ospree/docs/photoperiod/figures/ospree_photopmap2.pdf} 
\caption{\textbf{OSPREE experiments that manipulate photoperiod}, and their equivalent spatial and temporal shifts, mapped(A), and graphed (B). Observed rates of spatial shifts are from Chen et al 2011; observed temporal shifts are from Parmesan et al 2006. }
 \label{fig:photomap}
 \end{figure}
