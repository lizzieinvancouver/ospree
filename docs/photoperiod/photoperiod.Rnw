...
\item Shifts in photoperiod may vary with latitude and time of year, especially since phenology varies with latitude (Figure \ref{fig:greenup}), and species responses to photoperiod vary with latitude (Figure \ref{fig:greenup}).
\item Photoperiod sensitivity can also vary with latitude (Figures \ref{fig:bbphoto}, \ref{fig:bbphotoxlat}), so it is unclear how these two things interact. Cat has added a text file to the latitude analysis folder that summarizes papers that have looked at latitudinal effects on photoperiod.
\end{enumerate}
...
\begin{figure}[p]
\centering
\includegraphics{/Users/aileneettinger/git/ospree/analyses/photoperiod/figures/photo_spacetime.pdf} %
\caption{\textbf{Photoperiod varies with latitude and throughout the year}, such that temporal shifts in activity yield larger changes in experienced photoperiod compared with spatial shifts.}
 \label{fig:spacetime}%
 \end{figure}
 
\begin{figure}[p]
\centering
\includegraphics{/Users/aileneettinger/git/ospree/docs/photoperiod/figures/Greenup_2012.pdf} %or use Greenup_?
\caption{\textbf{Green-up date varies with latitude} and varies among years. }
 \label{fig:greenup}%
 \end{figure}

\begin{figure}[p]
\centering
\includegraphics[width=50mm,scale=0.8]{/Users/aileneettinger/git/ospree/analyses/photoperiod/figures/scaled_photo_curve.pdf} 
\caption{\textbf{Photoperiod affects budburst}, generally by interacting with chilling and forcing. Thus, responses to photoperiod vary greatly among studies, depending on methodologies and other manipulating factors (e.g., temperature). }
\label{fig:bbphoto}
\end{figure}
 
\begin{figure}[p]
\centering
\includegraphics[width=50mm,scale=0.8]{/Users/aileneettinger/git/ospree/analyses/lat_analysis/figures/PhotoxLat.pdf} 
\caption{\textbf{Responses to photoperiod vary with latitude}.}
 \label{fig:bbphotoxlat}
 \end{figure}
\clearpage
...
\begin{figure}[p]
\centering
\includegraphics{/Users/aileneettinger/git/ospree/analyses/photoperiod/figures/2D_fagus_shifts.pdf} 
\caption{\textbf{Experimental treatments of photoperiod, compared to current and projected photoperiod experienced by Fagus sylvatica during budburst.}}
 \label{fig:fagus}
 \end{figure}
 
 \begin{figure}[p]
\includegraphics{/Users/aileneettinger/git/ospree/analyses/photoperiod/figures/2D_quercus_shifts.pdf} 
\caption{\textbf{Experimental treatments of photoperiod, compared to current and projected photoperiod experienced by Quercus robur during budburst.}}
 \label{fig:quercus}
 \end{figure}

\begin{figure}[p]
\centering
\includegraphics[width=100mm,scale=0.9]{/Users/aileneettinger/git/ospree/docs/photoperiod/figures/exp_space_time2.pdf} 
