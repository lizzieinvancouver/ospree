...
\section* {Glossary}
\begin{itemize}
\item \underline{budburst}: when one or more leaf buds have visible green tips. %the emergence of new leaves on a plant at the beginning of the growing season. %%CC: Please fix (EMW says "I don't think budburst is only at the start of the season and we may need to be more explicit in the 'emergence of new leaves' part ....") %CJC: a common definition is when the first green tip is visible. I know BBCH and the NPN do not specify the time of year so I do think it can be at any time. So we could say "when one or more leaf buds have visibile green tips" or something like that
