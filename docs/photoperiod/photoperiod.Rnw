...
% IMC: I would include a citation to Peñuelas' study on altitudinal shifts:
...
\item Other ideas? Local adaptation levels? Potential for evolution?
\end{enumerate}
