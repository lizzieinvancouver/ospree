...
\par Species experience different photoperiod regimes depending on their location in space and the seasonal timing of their activity. of this paper and how to work in Fig. on greenup, if it doesn't work here I think it works more generally to say: hey! plants leafout with this much photoperiod variation across space and time. That could actually be our first, simple take-home message. 
...
\item Update table/map to use 3 ER studies- these are likely to change with updates following treatment checks in october 2018.
\end{enumerate}
...
\caption{\textbf{Photoperiod is not a focus of many studies forecasting biological impacts of climate change}. Temperature is more often included as a keyword than photoperiod.}
 \label{fig:wos}%
 \end{figure}
