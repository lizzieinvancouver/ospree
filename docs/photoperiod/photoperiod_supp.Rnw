...
\par \textbf{Dan's methods for making the photo period curves (Figure 3)}
\par We selected OSPREE publications that had three or more photoperiod treatments, and, after reading the methods of these papers in detail, identified three that used three or more photoperiod treatments in the same experiment\citep{heide93a,ashby62,cafarra11b}. These experiments used forcing temperatures of 21 or 22 \degree C, Chilling varied considerably across experiments, and chilling level was categorized as follows:
\begin{itemize}
...
\par \textbf{Maps of temporal and spacial shifts in space and tim  (Figure 4)}
