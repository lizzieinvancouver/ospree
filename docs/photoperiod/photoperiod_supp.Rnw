...
\title{Supplemental Methods for \emph{Spatial and temporal shifts in photoperiod with climate change}} 
...
\section*{Quantifying and mapping differences in green-up across the United States and Europe (Figure 2)}
...
\section*{Mapping temporal and spatial shifts in space and time (Figure 3)}
...
\section*{Nonlinearities in phenological responses to daylength (Figure Box 1-1 in the main text)}
...
\section*{Comparing shifts in experienced photoperiod in experiments to those in the natural world with climate change (Figure Box 1-2 in the main text)}
