...
Accounting for the effects of phylogenetic structuring on the effects of environmental cues modelled jointly has an effect on model coefficients (Fig. \ref{}) 
