...
Interestingly, phylogenetic signal differs markedly across cues (Fig. \ref{}). Responses to photoperiod seem evolutionarily labile, with little variation across most species (XX days per standard unit of photoperiod) and a few exceptions from the genus \emph{Fagus}, known as particularly sensitive to photoperiod \citep{fu2019}. The question arises as to why would distantly related species respond more similarly to photoperiod than they do to forcing or chilling. A possibility is that the higher stability/predictability of seasonal photoperiod at any given latitude, would have not promoted a selection as stronger as that of forcing or chilling. %The latter...
\\
