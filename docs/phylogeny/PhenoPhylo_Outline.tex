...
Accounting for the effects of phylogenetic structuring on the effects of jointly modelled cues had an effect on model coefficients both for angiosperms (Fig. \ref{}) and gymnosperms (Fig. \ref{}). Not accounting for phylogeny (or assuming $\lambda \= 0) biased model coefficients, particularly so for forcing and somewhat less for chilling (Fig. \ref{}). Specifically, species sensitivities to forcing and chilling were underestimated on average (by XX and XX days per unit of standardized cue, respectively). Sensitivities to photoperiod, which showed weak phylogenetic signal were not biased in non-phylogenetic models (Fig. \ref{}), likely due to their low estimated $\lambda values. Model intercepts were not affected either (Fig. \ref{}). Assuming phylogenetic structuring to follow a Brownian Model of evolution ($\lambda \= 1) biased model coefficients too (Fig. \ref{}) although in the opposite direction. Doing so overestimated sensitivities to forcing and chilling (by XX and XX days per unit of standardized cue, respectively) and overestimated even more species sensitivities to photoperiod (Fig. \ref{}). Bias in model coefficients due to either ignoring or overestimating phylogenetic structuring of predictors seems to correlate with the estimated value of $\lambda so that, if their actual value is high, coefficients may suffer stronger bias if phylogeny is disregarded. In contrast, if predictor's $\lambda is actually low, bias would arise by forcing a Brownian Motion on those predictors (this situation being more unlikely in the literature). Results coincided qualitatively with those of gymnosperms, which were more variable as sample size is much lower (Fig. \ref{}).
...
\begin{figure} [H]
  \begin{center}
  \includegraphics[width=16cm]{figures/muplot_phylo_allcue_angio.pdf}
...
\begin{figure} [H]
  \begin{center}
  \includegraphics[width=16cm]{figures/muplot_phylo_allcue_gymno.pdf}
...
\begin{figure} [H]
  \begin{center}
  \includegraphics[width=14cm]{figures/Fig2_lambdas_sigmas.pdf}
...
\begin{figure} [H]
  \begin{center}
  \includegraphics[width=14cm]{figures/Est_correls_vs_lamb01_angio.pdf}
...
\begin{figure} [H]
  \begin{center}
  \includegraphics[width=14cm]{figures/Est_correls_vs_lamb01_gymno.pdf}
