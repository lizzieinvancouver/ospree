...
\usepackage{hyperref}
\externaldocument[main-]{PhenoPhylo_ms} %DLMay11: I think you are missing the segment that gets added to the label that gets cross referened, here I just use "main-" and added "supp-" to the maintext.
\usepackage{hyperref} %DLMay11: two packages for the url formatting
\urlstyle{same}
