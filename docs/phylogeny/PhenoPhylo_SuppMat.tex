...
\usepackage{hyperref}
\externaldocument{PhenoPhylo_ms} %DLMay11: I think you are missing the segment that gets added to the label that gets cross referened, here I just use "main-" and added "supp-" to the maintext.
\urlstyle{same}
...
\begin{tabular}{lrrrrrrr}
  \hline
Parameter & mean & sd & 2.5$\backslash$\% & 50$\backslash$\% & 97.5$\backslash$\% & \$n\_\{eff\}\$ & Rhat \\ 
  \hline
\$$\backslash$mu\_\{$\backslash$alpha\}\$ & 31.79 & 1.28 & 29.29 & 31.77 & 34.35 & 13779.62 & 1.00 \\ 
  \$$\backslash$mu\_\{$\backslash$beta\_\{force\}\}\$ & -7.46 & 0.89 & -9.19 & -7.46 & -5.71 & 2960.28 & 1.00 \\ 
  \$$\backslash$mu\_\{$\backslash$beta\_\{chill\}\}\$ & -8.75 & 0.81 & -10.29 & -8.76 & -7.11 & 6051.59 & 1.00 \\ 
  \$$\backslash$mu\_\{$\backslash$beta\_\{photo\}\}\$ & -1.21 & 0.46 & -2.10 & -1.20 & -0.29 & 2175.88 & 1.00 \\ 
  \$$\backslash$sigma\_\{$\backslash$alpha\}\$ & 16.35 & 1.00 & 14.46 & 16.31 & 18.41 & 10178.43 & 1.00 \\ 
  \$$\backslash$sigma\_\{$\backslash$beta\_\{force\}\}\$ & 5.20 & 0.82 & 3.76 & 5.15 & 6.93 & 677.74 & 1.00 \\ 
  \$$\backslash$sigma\_\{$\backslash$beta\_\{chill\}\}\$ & 6.84 & 0.78 & 5.40 & 6.80 & 8.46 & 1815.10 & 1.00 \\ 
  \$$\backslash$sigma\_\{$\backslash$beta\_\{photo\}\}\$ & 2.27 & 0.35 & 1.61 & 2.25 & 2.99 & 649.15 & 1.00 \\ 
  \$$\backslash$sigma\_y\$ & 12.57 & 0.18 & 12.23 & 12.57 & 12.94 & 12887.31 & 1.00 \\ 
   \hline
\end{tabular}
\endgroup
\end{table} \clearpage \pagebreak 
...
%DLMay11: I was having issues running this fig bc the path and name of the figure, but it worked fine when I changed these for my computer. 
\begin{figure}
  \begin{center}
  ...
  \label{fig:suppmuplot_all} %DLMay11 this fig label is in the main text too, so added supp
  \end{center}
\end{figure}
