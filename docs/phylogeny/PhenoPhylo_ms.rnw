...
=======
Most species respond to all three primary cues---forcing, chilling, and photoperiod \citep[Fig. \ref{fig:muplot_all}, Supporting Table \ref{tab:modelanglamb}, see also][]{Laube:2014a,ettinger2020}---with responses to chilling approximately five-fold greater than to photoperiod (phenological advances of \Sexpr{chillsens} days per standardized unit vs \Sexpr{photosens} days, for chilling and photoperiod, respectively; see Table \ref{tab:modelanglamb}). 
...
>>>>>>> 545e6b638fa41d77cf18b178b071d9753ee22711
