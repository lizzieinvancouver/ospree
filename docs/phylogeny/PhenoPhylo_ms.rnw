...
<<label=runcode, echo=FALSE, results=tex>>=
...
<<label=tables1, echo=FALSE, results=tex>>=
# tablemodelestimate
print(make.mytable1,
      floating=FALSE,
      size="footnotesize",   
...
<<label=tables2, echo=FALSE, results=tex>>=
# tablevaldatsource
print(make.mytable2,
      floating=FALSE,
      size="footnotesize",   
