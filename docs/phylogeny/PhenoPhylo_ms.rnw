...
\usepackage{hyperref}
\externaldocument[supp-]{PhenoPhylo_SuppMat}
...
$^{1}$GloCEE - Global Change Ecology and Evolution Group, Department of Life Sciences, University of Alcal?, Alcal? de Henares, Spain\\ % (ORCID: 0000-0002-8570-9312)
