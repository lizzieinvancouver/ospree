...
We had provided more details in the Fig. 4 caption, but now also clarify in the main text (see lines 221-224).\\ %14OctEMW -- give fig #?
...
\emph{Minor comments:}\\
\emph{L80-84: Disagree about the claim here. The models described in Ives and Helmus 2011, as well as Hadfield 2010 also allowed different estimations of the phylogenetic components of different predictors. In other words, the model described here can be fitted with those approaches too.}\\ % EMW14Oct -- typos!
