...
%DIF ADD PhenoPhylo_ms.tex                  Mon Mar 25 07:09:29 2024
...
\DIFaddend \section*{Abstract} %DIF >  150 words currently
...
\DIFdelbegin \DIFdel{We illustrate our method with an dataset on phenological responses to }\DIFdelend \DIFaddbegin \DIFadd{Combining our new method with phenological experiments manipulating }\DIFaddend temperature and daylength cues \DIFdelbegin \DIFdel{, determined experimentally for 191 woody species.
...
We find that variation is greater across species than across cues, }\DIFdelend \DIFaddbegin \DIFadd{of woody species, we find species differences dwarfed the mean differences between cues, especially for temperature, }\DIFaddend suggesting the current focus on \DIFdelbegin \DIFdel{identifying which cue is the strongest may be less important than predicting how each species responds to a combination of cues }\DIFdelend \DIFaddbegin \DIFadd{comparing across cues misses most variation}\DIFaddend . Further, our model provides insights on how evolutionary history has shaped responses to cues, suggesting stronger evolutionary dynamics in responses to temperature---especially cool winter temperatures---than daylength. Our \DIFaddbegin \R{whatisyourpaper2}\DIFadd{new }\DIFaddend approach provides a major advance in ecological forecasting, with implications for predicting the impacts of climate change and other anthropogenic forces on \DIFdelbegin \DIFdel{species interactions and ecosystem functioning}\DIFdelend \DIFaddbegin \DIFadd{ecosystems}\DIFaddend .
\clearpage
