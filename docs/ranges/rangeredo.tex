...
Our study interrogated the SPH; one of the most fundamental biological assumptions relating to the evolition of phenological cue presponses that is frequently asserted but rarely tested \citep[but see][]{Zohner:2017aa}. In our analyses, we found only mixed support for the SPH, highlighting the need to more holistically integrate multiple other kinds of drivers (community, phylogenetic) into the framework about the evolution of phenological cues.
...
There is currently a debate about the extent to which local adaptation shapes phenological cues \citep{Zeng2024}, and it is likely the strength of local adaptation varies among species, and phenological phases themselves \citep{Zeng2024,Savolainen2007}.
