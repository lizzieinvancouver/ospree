...
\begin{align*}
\alpha_{study} & \sim N(\mu_{\alpha_study}, \sigma_{\alpha_study}) \\
\alpha_{sp} & \sim N(\mu_{\alpha_sp}, \sigma_{\alpha_sp}) \\
\alpha_{pop} & \sim N(\mu_{\alpha_pop}, \sigma_{\alpha_pop}) \\
\beta_{forcing_{sp/pop}} \thicksim N(\mu_{forcing_[sp/pop]}, \sigma_{forcing_[sp/pop]}) \\
\beta_{photoperiod_{sp/pop}} \thicksim N(\mu_{photoperiod}, \sigma_{photoperiod_[sp/pop]}) \\
\end{align*}
