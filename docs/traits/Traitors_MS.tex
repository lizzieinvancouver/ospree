...
Our model estimates for the trait effects of seed mass on cue responses were all negative, however, given the nature of the log10 transformation and the resulting negative trait values, the inclusion of trait effects creates positive estimates and offset the effects of the cue responses in the absence of traits. Both acquisitive and conservative species exhibited similar budburst dates for both forcing and photoperiod responses. \\ % acq. vs con spp are responding differently, green = the slope is becoming less negative for F & C and not really changing for P, but for purprle, the slopes are all becoming more negative
