...
SLA :
Forcing: species with low SLA were more sensitive to forcing when the trait effects were accounted for. While high SLA individuals inherently advanced their bb in response to higher forcing, with no real effect of traits. % b_Quercus ilex; is this trend simply bc of the species we chose?
