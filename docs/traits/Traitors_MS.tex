...
We fit four models, with each trait modelled individually to species budburst data. Using the following joint hierarchical bayesian models, we estimated the relative effect of a given trait to be included in our model of cue responses to budburst date: % How much detail is needed - justify our approach or just include the model?
