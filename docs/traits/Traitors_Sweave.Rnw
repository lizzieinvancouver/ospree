...
Our model findings do support the idea that phenology is an important functional trait for woody plant growth. By incorporating phenology into the broader framework of plant funcitonal traits, we can better understand its in shaping species communities and ecosystem services.   
