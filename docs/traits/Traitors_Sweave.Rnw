...
Of the three cues commonly included in growth chamber studies, we consistently observed the strongest responses to increases in chilling, while the effects of photoperiod cues were weakest. This is in line with previous growth chamber studies, which also found chilling cues to have the strongest effect on budburst dates (citations?). This may reflect the role that chill units play in the transition from endodormancy, the phase in which woody plants are in a internally controlled state of inactivity during the coldest winter months, to ecodormancy, during which time growth inactivity is environmentally controlled and reflects limitations in resource availability \citep{Lang1987} Given the high fitness costs of premature growth in the spring, we would expect stronger selection for chilling cues. Previous work has also shown that responses in photoperiod cues contribute less to the timing of budburst or are more species specific. This is also reflected in our results, which also depict the effect of functional traits on photoperiod cue use to be relatively less than that of forcing and chilling. Some growth chamber studies such as \citep{Flynn20180}, however, have found compensatory interactions between species budburst and forcing and chilling cues, with greater forcing for example offsetting the effects of low chilling on the timing of budburst. The positive relationship we observed between height and forcing, but the negative response to chilling, might also be driving by such interactions between the two cues, however, the complexity of in our current analysis prevented us from exploring such interactions further.


To our surprise, the influence of LNC on photoperiod cues was weaker than it's cue response to forcing and photoperiod. This is a trait most commonly associated with photosynthetic potential and a proxy for the amount of nitrogen rich rubisco enzymes within a leaf (citation). The lack of a relationship therefore suggests that factors other than daylength, such as herbivore pressure, may be selecting for this functional trait.
...
Our model findings do support the idea that phenology is an important functional trait for woody plant growth. By incorporating phenology into the broader framework of plant funcitonal traits, we can better understand its role in shaping species communities as cliamtes continue to change. Advances in budburst phenology may be faciliatated by a species growth strategy and functional traits. Warming winter and spring temperatures are expected to result in species chilling requirements being met earlier \citep{Guy2014}, which could result in earlier release from endodormancy and budburst as forcing temperature thresholds are also met. Species that are most able to initiate growth in the spring and tolerate late frost events, will be more likely to track these changes in temperature. This could favour species that produce less costly leaves, with low LNC, as loss of tissue to frost would incurr a low fitness cost. Selection on the timing of budburst may also be constrained by species traits. This is particularly true for species with low LNC, as this trait correlates with the amount of photosynthetic machineray and photosynthetic potential. The rate of phenolgoical advances of these low LNC species may be limited by photoperiod and thier ability to acquire resources. Changes in cues and species phenoloiges will also likely alter species temporal niche, altering the compeitive landscape and trophic levels. Advances in late budbursting speices, which are on average taller and stronger competitors for light, would lead to earlier canopy closure and negatively impact understory species that are not also advnacing phenologically. Warming spring temperatures   
...
\beginHow might traits constrain/facilitate future shifts in phenology?
