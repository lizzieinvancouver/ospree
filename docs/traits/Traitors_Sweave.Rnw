...
A challenge of inferring the role of functional traits in relation to abiotic cues are a traits likelihood of playing multiple roles in species interactions and mediation of their environmental conditions. Such diversity in the role a trait may play could limit the adaptive potential of species to future climates. 

 Our study relating functional traits to phenology is unique from previous research in that we are drawing associations between the traits and the cue responses that define woody species phenologies. In general our model estimates are... connect to previous work....  


By incorporating phenology into the broader framework of plant funcitonal traits, we can better understand its role in shaping species communities as cliamtes continue to change. Warming winter and spring temperatures are expected to result in species chilling requirements being met earlier \citep{Guy2014}, which could result in earlier release from endodormancy and budburst as forcing temperature thresholds are also met earlier within a season. Species that are most able to initiate growth in the spring and tolerate late frost events, will be more likely to track these changes in temperature. This could favour species that produce less costly leaves, with high SLA, as loss of tissue to frost would incurr a lower fitness cost. Similarly species that produce smaller seeds will have greater dispersal and be more likely to expend their range and migrate polward as new communities at their range edge become hospitable. 
...
Areas of future study - will seed germination also shift with changing cues under climate change or will large seeded species seedlings get competitively excluded? 
 ...
 \begin{itemize}
\item Huang et al. 2018 - found several growth strategies - all combinations of early- fast, early-slow, late-fast etc - but looked at flowering
\item Osada 2017 - bb later for sp with greater LMA, thickness, Narea – driven by differences across deciduous and evergreen spp; 	Deciduous alone: bb positively correlated with leaf mass, area, vessel diam in cross spp comparisons
\item Kitamura et al 2007 - found no relationship between budburst of their focal oak species and SLA, LNC, etc.
\item Sun, S., D. Jin, and R. Li. 2006. LMA neg correl with leafout; larger LMA = earlier
 \end{itemize}
