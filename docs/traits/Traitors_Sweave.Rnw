...
Our results provide some of the first insights into the relationships between functional traits and phenological cue responses, supporting the covariation of phenology along gradients of acquistive and conservative growth strategies. While our analysis used trait and budburst data collected independently of one another, both the trait and OSPREE databases encompass a great diversity of species, collected across temperate forest systems. By including study effects in our trait model, we are able to better account for these sources of variability. As such, the relationships we observed are more likely to reflect general trends in trait relationships that scale acorss populations and species. Future studies should aim to include a greater diversity of speices and functional traits. For example including traits related to wood structure and defense compounds could provide new insights into the influence of temperature on vessel development and the potential for biotic pressures from herbivory to similiar influence phenology. In addition, future studies in which trait and phenologcial data are measured from within the same populations, are needed to determine whether the trends we observed also occur at finer ecological scales. 
...
Advances in budburst phenology may be faciliatated by a species growth strategy and functional traits.
