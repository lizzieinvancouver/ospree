...
%But what about SLA and photoperiod? 
...
A challenge of inferring the role of functional traits in relation to abiotic cues are a traits likelihood of playing multiple roles in species interactions and mediation of their environmental conditions. Such diversity in the role a trait may play could facilitate or limit the adaptive potential of species to future climates. Warming winter and spring temperatures are expected to result in species chilling requirements being met earlier \citep{Guy2014}, which would result in earlier release from endodormancy. As warmer springs allowing forcing temperature thresholds to also be met earlier, we predict species able to respond to lower cues to advance phenologically and budburst earlier in the spring. Our results suggest that this will include species with traits associated with aquisitive growth strategies.  Species that are most able to initiate growth in the spring and tolerate late frost events, will be more likely to track these changes in temperature. This could favour species that produce less costly leaves, with high SLA, as loss of tissue to frost would incurr a lower fitness cost. Similarly species that produce smaller seeds will have greater dispersal and be more likely to expend their range and migrate polward as new communities at their range edge become hospitable. 

Selection on the timing of budburst may also be constrained by species traits.  Species with low LNC for example, may be limited by photoperiod length and thier photosynthetic capacity. Changes in cues and species phenoloiges will also likely alter species temporal niche, altering the compeitive landscape and trophic levels. Advances in late budbursting speices, which are on average taller and stronger competitors for light, would lead to earlier canopy closure and negatively impact understory species that are not also advnacing phenologically. Warming spring temperatures   

Introduce invasive species - acquisitive growth strategies, earlier - filling empty temporal niche and changing the late season competitive landscape
small seeds = greater dispersal and likelihood of tracking climate niche? - invasion
