...
Variable & mean & sd & X2.5. & X50. & X97.5. & Rhat \\ 
  \hline
$\alpha_{\text{grand}}$ & 12.58 & 1.92 & 8.71 & 12.61 & 16.32 & 1.00 \\ 
  $\alpha_{\text{trait}}$ & 31.97 & 3.00 & 26.25 & 31.93 & 37.95 & 1.00 \\ 
  $\beta_{\text{force}}$ & -11.06 & 2.82 & -17.04 & -10.95 & -5.87 & 1.00 \\ 
  $\beta_{\text{chill}}$ & -3.63 & 4.26 & -12.77 & -3.47 & 4.21 & 1.00 \\ 
  $\beta_{\text{photoperiod}}$ & 1.42 & 2.33 & -3.34 & 1.44 & 5.84 & 1.00 \\ 
  $\beta_{\text{trait}.\text{force}}$ & 0.20 & 0.19 & -0.16 & 0.20 & 0.60 & 1.00 \\ 
  $\beta_{\text{trait}.\text{chill}}$ & -0.57 & 0.30 & -1.12 & -0.58 & 0.05 & 1.00 \\ 
  $\beta_{\text{trait}.\text{photo}}$ & -0.30 & 0.17 & -0.62 & -0.30 & 0.05 & 1.00 \\ 
  \end{tabular}
\end{table}
...
Variable & mean & sd & X2.5. & X50. & X97.5. & Rhat \\ 
  \hline
$\alpha_{\text{grand}}$ & 16.41 & 1.53 & 13.49 & 16.37 & 19.64 & 1.00 \\ 
  $\alpha_{\text{trait}}$ & 31.28 & 2.67 & 26.17 & 31.23 & 36.62 & 1.00 \\ 
  $\beta_{\text{force}}$ & -10.86 & 2.74 & -16.32 & -10.82 & -5.56 & 1.02 \\ 
  $\beta_{\text{chill}}$ & -17.27 & 5.10 & -28.33 & -17.02 & -7.91 & 1.01 \\ 
  $\beta_{\text{photoperiod}}$ & 1.05 & 2.75 & -4.39 & 1.06 & 6.55 & 1.00 \\ 
  $\beta_{\text{trait}.\text{force}}$ & 0.14 & 0.15 & -0.14 & 0.14 & 0.44 & 1.02 \\ 
  $\beta_{\text{trait}.\text{chill}}$ & 0.38 & 0.27 & -0.14 & 0.36 & 0.97 & 1.01 \\ 
  $\beta_{\text{trait}.\text{photo}}$ & -0.20 & 0.15 & -0.50 & -0.20 & 0.10 & 1.00 \\ 
  \end{tabular}
\end{table}
...
Variable & mean & sd & X2.5. & X50. & X97.5. & Rhat \\ 
  \hline
$\alpha_{\text{grand}}$ & 22.80 & 1.40 & 20.06 & 22.78 & 25.58 & 1.01 \\ 
  $\alpha_{\text{trait}}$ & 30.84 & 2.57 & 25.84 & 30.81 & 35.94 & 1.00 \\ 
  $\beta_{\text{force}}$ & -21.19 & 6.63 & -34.00 & -21.13 & -8.27 & 1.02 \\ 
  $\beta_{\text{chill}}$ & -35.95 & 9.54 & -54.91 & -35.83 & -17.01 & 1.01 \\ 
  $\beta_{\text{photoperiod}}$ & -8.92 & 5.79 & -20.55 & -8.90 & 2.63 & 1.00 \\ 
  $\beta_{\text{trait}.\text{force}}$ & 0.56 & 0.28 & 0.01 & 0.55 & 1.10 & 1.02 \\ 
  $\beta_{\text{trait}.\text{chill}}$ & 1.08 & 0.40 & 0.29 & 1.07 & 1.86 & 1.01 \\ 
  $\beta_{\text{trait}.\text{photo}}$ & 0.28 & 0.24 & -0.19 & 0.28 & 0.75 & 1.00 \\ 
  \end{tabular}
\end{table}
...
Variable & mean & sd & X2.5. & X50. & X97.5. & Rhat \\ 
  \hline
$\alpha_{\text{grand}}$ & 1.84 & 0.48 & 0.90 & 1.84 & 2.77 & 1.00 \\ 
  $\alpha_{\text{trait}}$ & 31.43 & 2.70 & 26.33 & 31.40 & 36.84 & 1.00 \\ 
  $\beta_{\text{force}}$ & -8.04 & 1.57 & -11.19 & -8.03 & -4.98 & 1.00 \\ 
  $\beta_{\text{chill}}$ & -9.36 & 2.79 & -15.05 & -9.28 & -4.02 & 1.00 \\ 
  $\beta_{\text{photoperiod}}$ & -1.44 & 1.27 & -3.90 & -1.47 & 1.06 & 1.00 \\ 
  $\beta_{\text{trait}.\text{force}}$ & -0.29 & 0.67 & -1.58 & -0.29 & 1.03 & 1.00 \\ 
  $\beta_{\text{trait}.\text{chill}}$ & -1.08 & 1.09 & -3.20 & -1.09 & 1.07 & 1.00 \\ 
  $\beta_{\text{trait}.\text{photo}}$ & -0.59 & 0.58 & -1.74 & -0.59 & 0.54 & 1.00 \\ 
  \end{tabular}
\end{table}
