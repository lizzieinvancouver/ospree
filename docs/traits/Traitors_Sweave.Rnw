...
\date{\today}
\author{Deirdre Loughnan$^1$, Faith A M Jones$^1$, Geoffrey Legault$^1$, Mira Garner$^2$, Darwin Sodhi$^3$, Daniel Buonaiuto$^4$, Catherine Chamberlain$^5$, Ignacio Morales Castilla $^6$, Ailene Ettinger$^7$,  and E M Wolkovich$^1$}
\maketitle 
...
\begin{figure}[h!]
 ...
 \includegraphics[width=\textwidth]{..//..//analyses/traits/figures/cuetrait_wtrend_nprior.pdf} 
    ...
    \label{fig:cuetraits}
\end{figure}
The relationship between species height and cue responses was negative, with increasing tall trees having more negative responses to each cue \ref{fig:cuetraits}. Of the three cues, height had the strongest influence on chilling, with an estimated interaction parameter of \Sexpr{htBCSpMean} (90\% credible interval: \Sexpr{lower_htBCSpMean},\Sexpr{upper_htBCSpMean}). The response to forcing was also negative, at \Sexpr{htBFSpMean} (90\% credible interval: \Sexpr{lower_htBFSpMean},\Sexpr{upper_htBFSpMean}), as was the photoperiod slope at \Sexpr{htBPSpMean} (90\% credible interval: \Sexpr{lower_htBPSpMean},\Sexpr{upper_htBPSpMean}). Tall trees like \textit{Acer pseudoplantanus}, have more negative slopes in the full model compared to models with a zero trait effect, and a much greater difference in their slopes than shorter trees like \textit{Corylus avettana} \ref{fig:slopes}. The trait effect of photoperiod is much smaller, with the slopes of the full model and model without the effect of trait being similar. 

We found a negative relationship between SLA and each cue response  \ref{fig:cuetraits}, meaning that as SLA increased, responses to each cue became more negative. Chilling was most strongly influenced by SLA (interaction parameter: \Sexpr{slaBCSpMean}: 90\% credible interval: \Sexpr{lower_slaBCSpMean},\Sexpr{upper_slaBCSpMean}). Species' responses to forcing were also negatively correlated with SLA values ( interaction parameter:  \Sexpr{slaBFSpMean}, 90\% credible interval: \Sexpr{lower_slaBFSpMean},\Sexpr{upper_slaBFSpMean}), as were responses to photoperiod (interaction parameter: \Sexpr{slaBPSpMean}, 90\% credible interval: \Sexpr{lower_slaBPSpMean},\Sexpr{upper_slaBPSpMean}). For species with high SLA values, such as \textit{Fagus grandifolia}, this negative trait effect produced a more negative slope in the full model relative to the slope when the trait effect is set to zero. The difference in the slopes of species with leaves with low SLA, such as \textit{Quercus ilex}, is much smaller \ref{fig:sla}. The relatively small trait effect of photoperiod is reflected in the smaller difference in the slopes between the full model and the model without the effect of trait \ref{fig:sla}.


The relationship between LNC and cue responses, was weaker compared to the relationships with other traits, but we still found a negative association between LNC and cue responses \ref{fig:cuetraits}. Chilling was most influenced by LNC (interaction parameter: \Sexpr{lncBCSpMean} :90\% credible interval: \Sexpr{lower_lncBCSpMean},\Sexpr{upper_lncBCSpMean}), followed by the forcing (interaction parameter: \Sexpr{lncBFSpMean}: 90\% credible interval: \Sexpr{lower_lncBFSpMean},\Sexpr{upper_lncBFSpMean}), while photoperiod had the smallest influence from LNC (interaction parameter: \Sexpr{lncBPSpMean} :90\% credible interval: \Sexpr{lower_lncBPSpMean},\Sexpr{upper_lncBPSpMean}). Species like \textit{Alnus glutinosa} that produce leaves with high LNC, the negative trait effect resulted in a more negative slope in the full model relative to the slope of the zero trait effect model. In contrast, species with low LNC like \textit{Quercus ilex} have a much smaller difference in their slopes \ref{fig:slopes}. The model estimated trait effect of LNC for photoperiod is relatively negligible, producing no noticeable differences between the full model and the zero trait effect model  \ref{fig:slopes}. 
...
Variable & mean & sd & X2.5. & X50. & X97.5. & Rhat \\ 
  \hline
Grand trait mean & 12.58 & 1.92 & 8.71 & 12.61 & 16.32 & 1.00 \\ 
  Grand Species mean & 31.97 & 3.00 & 26.25 & 31.93 & 37.95 & 1.00 \\ 
  Beta Forcing & -11.06 & 2.82 & -17.04 & -10.95 & -5.87 & 1.00 \\ 
  Beta Chilling & -3.63 & 4.26 & -12.77 & -3.47 & 4.21 & 1.00 \\ 
  Beta Photoperiod & 1.42 & 2.33 & -3.34 & 1.44 & 5.84 & 1.00 \\ 
  Beta Trait x Forcing & 0.20 & 0.19 & -0.16 & 0.20 & 0.60 & 1.00 \\ 
  Beta Trait x Chilling & -0.57 & 0.30 & -1.12 & -0.58 & 0.05 & 1.00 \\ 
  Beta Trait x Photoperiod & -0.30 & 0.17 & -0.62 & -0.30 & 0.05 & 1.00 \\ 
  \end{tabular}
\end{table}
...
Variable & mean & sd & X2.5. & X50. & X97.5. & Rhat \\ 
  \hline
Grand trait mean & 16.41 & 1.53 & 13.49 & 16.37 & 19.64 & 1.00 \\ 
  Grand Species mean & 31.28 & 2.67 & 26.17 & 31.23 & 36.62 & 1.00 \\ 
  Beta Forcing & -10.86 & 2.74 & -16.32 & -10.82 & -5.56 & 1.02 \\ 
  Beta Chilling & -17.27 & 5.10 & -28.33 & -17.02 & -7.91 & 1.01 \\ 
  Beta Photoperiod & 1.05 & 2.75 & -4.39 & 1.06 & 6.55 & 1.00 \\ 
  Beta Trait x Forcing & 0.14 & 0.15 & -0.14 & 0.14 & 0.44 & 1.02 \\ 
  Beta Trait x Chilling & 0.38 & 0.27 & -0.14 & 0.36 & 0.97 & 1.01 \\ 
  Beta Trait x Photoperiod & -0.20 & 0.15 & -0.50 & -0.20 & 0.10 & 1.00 \\ 
  \end{tabular}
\end{table}
...
Variable & mean & sd & X2.5. & X50. & X97.5. & Rhat \\ 
  \hline
Grand trait mean & 22.80 & 1.40 & 20.06 & 22.78 & 25.58 & 1.01 \\ 
  Grand Species mean & 30.84 & 2.57 & 25.84 & 30.81 & 35.94 & 1.00 \\ 
  Beta Forcing & -21.19 & 6.63 & -34.00 & -21.13 & -8.27 & 1.02 \\ 
  Beta Chilling & -35.95 & 9.54 & -54.91 & -35.83 & -17.01 & 1.01 \\ 
  Beta Photoperiod & -8.92 & 5.79 & -20.55 & -8.90 & 2.63 & 1.00 \\ 
  Beta Trait x Forcing & 0.56 & 0.28 & 0.01 & 0.55 & 1.10 & 1.02 \\ 
  Beta Trait x Chilling & 1.08 & 0.40 & 0.29 & 1.07 & 1.86 & 1.01 \\ 
  Beta Trait x Photoperiod & 0.28 & 0.24 & -0.19 & 0.28 & 0.75 & 1.00 \\ 
  \end{tabular}
\end{table}
...
Variable & mean & sd & X2.5. & X50. & X97.5. & Rhat \\ 
  \hline
Grand trait mean & 1.84 & 0.48 & 0.90 & 1.84 & 2.77 & 1.00 \\ 
  Grand Species mean & 31.43 & 2.70 & 26.33 & 31.40 & 36.84 & 1.00 \\ 
  Beta Forcing & -8.04 & 1.57 & -11.19 & -8.03 & -4.98 & 1.00 \\ 
  Beta Chilling & -9.36 & 2.79 & -15.05 & -9.28 & -4.02 & 1.00 \\ 
  Beta Photoperiod & -1.44 & 1.27 & -3.90 & -1.47 & 1.06 & 1.00 \\ 
  Beta Trait x Forcing & -0.29 & 0.67 & -1.58 & -0.29 & 1.03 & 1.00 \\ 
  Beta Trait x Chilling & -1.08 & 1.09 & -3.20 & -1.09 & 1.07 & 1.00 \\ 
  Beta Trait x Photoperiod & -0.59 & 0.58 & -1.74 & -0.59 & 0.54 & 1.00 \\ 
  \end{tabular}
\end{table}
