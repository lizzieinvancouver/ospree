...
We found that the functional traits of our assemblage of woody plant species did influence plant responses to phenological cues. In general, our findings suggest species associated with acquisitive growth strategies, producing high SLA and LNC leaves, shorter heights, and small seeds, advance their budburst dates in response to increasing chilling cues. Interestingly, the relationships of traits to forcing and photoperiod cues were only partially in line with our predictions. Trees with high SLA and LNC and small seeds did correlate with advances in budburst as forcing increased. However, the response of forcing cues to height contrasted our predictions, with taller trees requiring less forcing temperatures to advance their budburst. Our model estimates also contrasted our predictions for SLA and photoperiod, with species with leaves with high SLA values having a stronger cue response and requiring longer photoperiods to advance budburst. %be more explict: The remaining three traits did follow our predictions, with tall species with large seeds and leaves with low LNC having greater responses to longer photoperiods. 

Of the three cues commonly included in growth chamber studies, we consistently observed the strongest responses to increases in chilling, while the effects of photoperiod cues were weakest. This is in line with previous growth chamber studies, which also found chilling cues to have the strongest effect on budburst dates (is this true, find citations). This may reflect the role that chill units play in the transition from endodormancy to ecodormancy, where plants transition from complete dormancy to being more physiologically active and responsive to forcing cues (citation). Previous work has also shown that responses in photoperiod cues contribute less to the timing of budburst. This is reflected in our own results that suggests the effect of other functional traits on photoperiod cue use is relativley less than that to forcing and chilling. \citep{Flynn20180}, however, suggests there are interactions between species forcing and cue use. This might explain the positive response between height and forcing or SLA and photoperiod, however, we were unable to include interactions in our current model given its complexity.
