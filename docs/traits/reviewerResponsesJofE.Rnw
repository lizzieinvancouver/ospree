...
We agree with the reviewer that this literature has many contradictory examples and requires careful and nuanced discussion. We also appreciate the reviewer for identifying several places where typos in the text and figure have lead to contradictions and confusion. We have expanded on our discussion of the literature in both the introduction and discussion and have added additional citations to support our predictions and the nuance of how we define acquisitive and conservative growth strategies.  
...
Our predictions are based on the functional trait literature, including \citep[classic work by][]{Reich1992, Westoby1998, Poorter2006}, but we have provided more detail in the main text to better reflect the nuance of this work and more clearly support our predictions. 
...
We apologize for the confusion. We have revised this section of the abstract to clarify our main finding and in response to a comment from the other Reviewer as well (\lr{R2_Aa} to \lr{R2_Ab}). 

\emph{L19: Where did the high nitrogen leaves belong to if early and late species had low nitrogen?}\\

Thank you for bringing our attention to this typo, it has been corrected on \lr{R2_Aa}.

\emph{L20: Not clear what the authors want to say here. Maybe be more precise about the patterns regarding late species.}\\

As mentioned above, we have revised this section to improve clarity and better communicate our primary findings. 
...
We agree that this is a complicated topic, but after discussing this and alternative phrasings with coauthors, we think the terms "proximate" and "ultimate" are best and true to how the topic is discussed in the literature. 
...
We agree that how we referenced the literature in this sentence could lead to confusion and have revised both the sentence and the references used to more clearly make our argument.  
