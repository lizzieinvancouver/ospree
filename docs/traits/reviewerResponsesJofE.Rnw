...
We have revised this section of the manuscript substantially from \lr{R2-74a} to \lr{R2-74b} to address comments from both Reviewers. 
...
We have addressed this comment on \lr{R2_84} by explicilty stating that we mean frost risk and nutrient availability.
