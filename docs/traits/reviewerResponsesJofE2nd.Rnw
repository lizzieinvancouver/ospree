...
We updated this sentence to specify that we are referring to the plant species to accurately reflect the studies of tree and herbaceous plants referenced here (\lr{R2_331}). \\
...
We can see the reviewers point and now clarify this point on \lr{R2_forest} and have added a sentence to highlight the potential for alternate cues to drive trait-phenology relationships in other communities from \lr{R2_forest2} to \lr{R2_forest2b}.\\
