...
Thank you for finding is typo, it has been corrected. 
...
The superscript T is used to concisely denote a transposed matrix. To further readers understanding of the equations, we have simplifed the notation of our equations.  
