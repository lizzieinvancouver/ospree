...
\begin{quote}
But habitat conditions can still create considerable intraspecific variation, which for some traits has been shown to be considerable or even exceed interspecific trait variation \citep{Albert2011,Siefert2015,Zuleta2022}. 
\end{quote}
