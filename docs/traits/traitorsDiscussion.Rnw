...
\item Whether trait effects led to advanced or delayed budburst phenology was generally aligned with well known gradients in traits, spanning acquisitive to conservative growth strategies
\item Responses were greatest for traits relating to growth strategies, with SLA, LNC and height all depicting strong responses across our three cues, while our reproductive trait---seed mass------showed weak response
...
\item Something about variation perhaps? %Oct31 -- since your model is really good at partitioning this. 
\end{enumerate}
...
\item It is necessary to incorporate phenology into species trait syndromes for us infer species responses to climate change. %Oct31 -- good point, flip it around to drop the PV and it will be even better
\begin{enumerate}
