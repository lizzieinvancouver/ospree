...
\item Spring phenology is ecologically important---carbon sequestration, species interactions etc % short! 3 sentences is likely enough...
\begin{enumerate}
...
\item Amidst these trends, spring (forest) phenology is highly variable across years and species % or keep more general and don't get into forests yet?
\begin{enumerate}
...
\begin{enumerate}
\item spp with traits associated with acquisitive growth (high SLA, high LNC, short heights, small seeds) will have cue requirements associated with low forcing, chilling, and photoperiod % switch to arly
\item Spp that are better competitors with conservative growth and later budburst, with low SLA and LNC, tall heights, and large seeds, will have phenological response associated with high forcing, chilling, and photoperiod requirements % early-late
\item Gradient of early-late = cues: early species are low force/chill/photo, later species are high chill or photo or both and likely higher forcing % may be short para on its own
\end{enumerate}
