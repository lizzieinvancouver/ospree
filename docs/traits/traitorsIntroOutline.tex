...
BROAD outline ... 
%EMWJan8 -- can you make each # a paragraph for the next round -- so each # would be the gist of a topic sentence then?

\begin{enumerate}

\item Open with phenological diversity (lots of it across spp. most of it unexplained, cite Laube, Flynn etc. work)
%EMWJan8 -- Nice stuff below, but I think you may have at least two paragraphs ... you need one paragraph first on what is phenological diversity (plants leaf out etc. at different times) before you get into the temporal niche (here you can transition with 'why are plants so diverse' perhaps at end of paragraph). Otherwise it's way too fast a funnel.
\begin{enumerate}
